...
class RTL : public Shared::ActorInterface

{
public:
	QByteArray asciiModuleName() const
	{
		return QByteArray("Kumir Standard Library");
	}
...
class Files : public Shared::ActorInterface
{
	QByteArray asciiModuleName() const
	{
		return QByteArray("Files");
	}

	QString localizedModuleName(const QLocale::Language) const
	{
		return QString::fromUtf8("Файлы");
	}
...
class Strings : public Shared::ActorInterface
{
	QByteArray asciiModuleName() const
	{
		return QByteArray("String Utilities");
	}

	QString localizedModuleName(const QLocale::Language) const
	{
		return QString::fromUtf8("Строки");
	}
