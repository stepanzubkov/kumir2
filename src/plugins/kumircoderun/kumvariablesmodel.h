...
public:
	...
	inline Type itemType() const
	{
		return _type;
	}
	inline int numberInTable() const
	{
		return _tableNumber;
	}
	inline TableOfVariables *table() const
	{
		return _table;
	}
	inline const VM::Variable *variable() const
	{
		return _variable;
	}
	inline QVector<int> arrayIndeces() const
	{
		return _indeces;
	}
	QString name() const;
	...
	inline quint64 framePointer() const
	{
		return _framePointer;
	}
	inline void setFramePointer(quint64 p)
	{
		_framePointer = p;
	}
private:
